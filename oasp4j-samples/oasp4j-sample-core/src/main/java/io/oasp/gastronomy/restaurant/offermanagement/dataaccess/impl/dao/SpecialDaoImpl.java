...
public class SpecialDaoImpl extends ApplicationDaoImpl<SpecialEntity> implements SpecialDao {
  ...
  public PaginatedListTo<SpecialEntity> findSpecials(SpecialSearchCriteriaTo criteria) {
    ...
    WeeklyPeriodEmbeddable periodEmbeddable = new WeeklyPeriodEmbeddable();
    periodEmbeddable.setEndingDay(activeperiod.getEndingDay());
    periodEmbeddable.setEndingHour(activeperiod.getEndingHour());
    periodEmbeddable.setStartingDay(activeperiod.getStartingDay());
    periodEmbeddable.setStartingHour(activeperiod.getStartingHour());

    WeeklyPeriodEmbeddable activePeriod = periodEmbeddable;
